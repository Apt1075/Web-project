      ...
      //  $sql = "INSERT INTO Hostel_Manager (Student_id, Fname, Lname, Mob_no, Dept, Year_of_study, Pwd) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        //$stmt = mysqli_stmt_init($conn);
          ...
          if($row = mysqli_fetch_assoc($result)){
            ...
            $sql = "INSERT INTO Hostel_Manager(Username, Fname, Lname, Mob_no,Email, Hostel_id, Pwd, Isadmin) VALUES('$username', '$fname', '$lname', '$mobile','$email', '$HostelID', '$hashedPwd', '$zz')";
