...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="home.php">KGI <span class="display"></span></a></h1>
				...
				<li class="visible">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-1)" xlink:href="web_home/images/img1.jpg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
				...
				<li class="next-slide">
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-2)" xlink:href="web_home/images/121.jpeg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
				...
				<li>
					<div class="svg-wrapper">
						<svg viewBox="0 0 1400 800">
							...
							<image height='800px' width="1400px" clip-path="url(#cd-image-3)" xlink:href="web_home/images/123.jpeg"></image>
						</svg>
					</div> <!-- .svg-wrapper -->
					<div class="cd-radial-slider-content text-center">
						<div class="wrapper">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand" href="https://kgikanpur.in/" target="_blank">KGI<span class="display">KANPUR</span></a>
		</div>
		<div class="footer-grid">
			...
			<div class="list-footer">
				...
				ADDRESS
EMAIL
kgikanpur2008@gmail.com
OFFICE
krishna institute of technology, kanpur gram- amiliha post- tatiyaganj mandhana, kanpur (up) – 209217
OFFICE
7318157000,9956988222
	</div>
			</div>
		</div>
	</div>
